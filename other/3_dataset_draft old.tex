...
Annotations include: (1) the aggressive action being performed, with a total of 21 action categories; (2) a natural-language description of the aggressor; (3) a natural-language description of the victim; (4) the environment or setting; and (5) descriptions of any bystanders present but not directly participating.
